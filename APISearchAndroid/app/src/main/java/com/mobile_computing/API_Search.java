    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((DatumAdapter) m_adapter).setOnItemClickListener(new DatumAdapter.DatumClickListener() {
            ...
            public void onItemClick(int position, View v) {
                ...
                toast.show();
                Intent myintent=new Intent(API_Search.this, ResultDisplayActivity.class);
                myintent.putExtra("sampleObject", (Serializable) ((DatumAdapter) m_adapter).getItem(position));
